;(function (e, t, n) {
      ...
      if (t.type == 'password') {
        if (!r.data('placeholder-textinput')) {
          try {
            ...
            e = n('<input>').attr(n.extend(l(this), { type: 'text' }))
          }
          e.removeAttr('name')
            .data({ 'placeholder-password': r, 'placeholder-id': i })
  ...
  var i = 'placeholder' in t.createElement('textarea')
  var s = n.fn
  var o = n.valHooks
  var u = n.propHooks
  var a
  ...
  if (r && i) {
    ...
    f.input = f.textarea = true
  } else {
    f = s.placeholder = function () {
      var e = this
      e.filter((r ? 'textarea' : ':input') + '[placeholder]')
        .not('.placeholder')
        .bind({ 'focus.placeholder': c, 'blur.placeholder': h })
