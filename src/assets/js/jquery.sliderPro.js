  ...
  SliderPro.prototype = {
    ...
    _updateSlidesPosition: function () {
      ...
      for (
        ...
        var slide = this.$slides
          .find('.sp-slide')
          .eq(this.slidesOrder[slideIndex])
        slide.css(
          this.positionProperty,
          selectedSlidePixelPosition +
    ...
    _resetSlidesPosition: function () {
      for (
        ...
        slide.css(
          this.positionProperty,
          slideIndex * (this.slideSize + this.settings.slideDistance)
        )
      }

      var newSlidesPosition =
        -parseInt(
          this.$slides
            .find('.sp-slide')
            .eq(this.selectedSlideIndex)
      ...
      if (this.settings.visibleSize !== 'auto') {
        if (this.settings.orientation === 'horizontal') {
          ...
          this.visibleOffset = Math.round(
            (this.$slider.width() - this.slideWidth) / 2
          )
        } else {
          ...
          this.visibleOffset = Math.round(
            (this.$slider.height() - this.slideHeight) / 2
          )
        }
      }
    ...
    _resizeHeightTo: function (height) {
      ...
      if (
        ...
        this.$slidesMask
          .stop()
          .animate(css, this.settings.heightAnimationDuration, function (
            event
          ) {
            // Fire the 'resizeHeightComplete' event
            that.trigger({ type: 'resizeHeightComplete' })
  ...
  SliderProSlide.prototype = {
    ...
    getSize: function () {
      ...
      if (
        this.hasImages === true &&
        this.areImagesLoaded === false &&
        typeof this.$slide.attr('data-loading') === 'undefined'
      ) {
        this.$slide.attr('data-loading', true)

        var status = SliderProUtils.checkImagesComplete(
          this.$slide,
          function () {
          ...
          $slide.find('img').each(function () {
            ...
            if (imageSource !== '') {
              ...
              if (
                ...
                that._loadConditionalImage($image, imageSource, function (
                  newImage
                ) {
    ...
    _checkAndLoadVisibleImages: function () {
      ...
      var that = this,
        ...
        visibleOnSides = Math.ceil(
          (this.visibleSlidesSize - this.slideSize) / 2 / this.slideSize
        ),
...
;(function (window, $) {
  ...
  var Layers = {
    ...
    _layersOnGotoSlide: function (event) {
      if (
        this.previousSlideIndex !== this.selectedSlideIndex &&
        this.settings.waitForLayers === false
      ) {
    ...
    _onTouchEnd: function (event) {
      ...
      if (Math.abs(touchDistance) < this.settings.touchSwipeThreshold) {
        ...
        var slideArrayDistance =
          touchDistance / (this.slideSize + this.settings.slideDistance)
        ...
        var nextSlideIndex = this.slidesOrder[
          $.inArray(this.selectedSlideIndex, this.slidesOrder) -
            slideArrayDistance
        ]
      ...
      video.on('click.' + NS, function (event) {
        ...
        src =
          provider === 'youtube'
            ...
            : 'http://player.vimeo.com/video/' + id + '?api=1'
