...
!(function (a, b) {
  ...
  d.prototype = {
    ...
    update: function () {
      ...
      for (var c = this.slides.length - 1; c >= 0; c--)
        if (
          0 === this.$slider.find('.sp-slide[data-index="' + c + '"]').length
        ) {
          var d = this.slides[c]
  ...
  ;(e.prototype = {
    ...
    getSize: function () {
      ...
      if (
        ...
        return 'complete' === d
          ? ((a = this.calculateSize()), { width: a.width, height: a.height })
          : 'loading'
      }
    ...
    resizeMainImage: function (a) {
      ...
      this.settings.autoHeight === !0
        ...
        this.settings.centerImage === !0 &&
          this.$mainImage.css({
            marginLeft:
              0.5 * (this.$imageContainer.width() - this.$mainImage.width()),
            marginTop:
              0.5 * (this.$imageContainer.height() - this.$mainImage.height()),
          })
    },
    destroy: function () {
  ...
  var f = {
    ...
    checkIE: function () {
      ...
      return (
        (this.isIE =
          -1 !== b.indexOf('MSIE') || b.match(/Trident.*rv\:11\./) ? !0 : !1),
        this.isIE
      )
    },
  }
            ...
            if (this.$slider.hasClass('sp-swiping'))
              ...
              b.each(this.slides, function (a, b) {
                var g = b.getIndex(),
                  h = b.$slide
                g === f
                  ? (h.css({ opacity: 0, left: 0, top: 0, 'z-index': 20 }),
                    (c = h))
                  : g === e.selectedSlideIndex
                  ? (h.css({ opacity: 1, left: 0, top: 0, 'z-index': 10 }),
                    (d = h))
  ...
  (function (a) {
    ...
    ;(j.prototype = new d()),
      ...
      (j.prototype._init = function () {
        var a = this,
          b = this.$video.attr(
            this.$video.hasClass('video-js') ? 'id' : 'data-videojs-id'
          )
