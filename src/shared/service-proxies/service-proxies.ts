...
export class CreateDeliveryTimeDto implements ICreateDeliveryTimeDto {
  ...
  init(_data?: any) {
    if (_data) {
      this.preferableTimeDelivery = _data['preferableTimeDelivery']
        ? moment(_data['preferableTimeDelivery'].toString())
        : <any>undefined
  ...
  toJSON(data?: any) {
    data = typeof data === 'object' ? data : {}
    data['preferableTimeDelivery'] = this.preferableTimeDelivery
      ? this.preferableTimeDelivery.toISOString()
      : <any>undefined
